...
1. Envia uma cor de teste para o dispositivo
...
- **3.  Definir Brilho**: escolha um dos níveis de brilho listados e o teclado mudará para ele
- **4. Reconfigurar**: apaga a configuração salva e roda o assistente de identificação de novo (útil se você trocar de teclado ou a identificação salva parar de funcionar)
...
└── src/
    ...
    ├── cli.py                # encaminhamento e loop principal
    └── menu.py               # construção dos menus
```
...
- [ ] Adicionar suporte a pywal
- [ ] Criação e personalização de perfis (macros/iluminação)
